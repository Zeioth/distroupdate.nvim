...
| **release_tag** | `nil` |  If this option is used, the option `channel` will be ignored, and the updater will download the release you specify. The format must be semantic versioning, like: `v1.0`. |
...
| **:NvimReload** | Hot reloads the specified files without need to restart nvim. |
